...
as typed :class:`~pathlight_mcp.cdp._types.DOMNode` and
:class:`~pathlight_mcp.cdp._types.BoxModel` dataclasses.
...
class DOMDomain(CDPDomain):
    ...
    :class:`~pathlight_mcp.cdp._types.DOMNode` and
    :class:`~pathlight_mcp.cdp._types.BoxModel` instances.
    ...
    def get_document(self, *, depth: int = -1) -> DOMNode:
        ...
        :class:`~pathlight_mcp.cdp._types.DOMNode`.
    ...
    def get_box_model(
        ...
        :class:`~pathlight_mcp.cdp._types.BoxModel`.
