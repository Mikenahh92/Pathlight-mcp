...
and return raw CDP data as typed :class:`~pathlight_mcp.cdp._types.AXNode`
dataclasses.
...
class AccessibilityDomain(CDPDomain):
    ...
    :class:`~pathlight_mcp.cdp._types.AXNode` instances.
    ...
    def get_full_ax_tree(self, *, timeout: float | None = None) -> list[AXNode]:
        ...
        node to an :class:`~pathlight_mcp.cdp._types.AXNode`.
