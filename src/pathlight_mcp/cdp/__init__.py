...
Domain wrappers (see :mod:`pathlight_mcp.cdp.domains`):
...
from pathlight_mcp.cdp._types import (
...
from pathlight_mcp.cdp.domains import (
    AccessibilityDomain,
    CDPDomain,
    DOMDomain,
    InputDomain,
...
from pathlight_mcp.cdp.protocol import CDPEvent, CDPMessage, CDPResponse
