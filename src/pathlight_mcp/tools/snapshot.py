...
calls :meth:`~pathlight_mcp.backends.base.DesktopBackend.snapshot`, normalizes
the raw tree dict into :class:`~pathlight_mcp.models.NormalizedElement` instances,
...
def _dict_to_element(data: dict[str, Any]) -> NormalizedElement:
    ...
    :func:`~pathlight_mcp.backends.router._tag_tree_refs`), it is stored in
...
def _assign_refs_recursive(element: NormalizedElement, ref_store: "ElementRefStore") -> None:
    ...
    :func:`~pathlight_mcp.backends.router._tag_tree_refs`), that tagged handle
    ...
    :class:`~pathlight_mcp.backends.router.BackendRouter`.
    """
