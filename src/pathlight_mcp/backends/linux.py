...
to :mod:`pathlight_mcp.backends._xlib_focus` per architecture §3.2 and §10.
...
class LinuxBackend(DesktopBackend):
    ...
    def _xlib_activate(accessible: Any) -> None:
        ...
        Delegates to :func:`pathlight_mcp.backends._xlib_focus.xlib_activate`.

        Raises:
            ImportError: If ``python-xlib`` is not installed.
            Exception: If the xlib activation fails.
        """
        from pathlight_mcp.backends._xlib_focus import xlib_activate
    ...
    def snapshot(
        ...
        in :mod:`pathlight_mcp.models.mappings`.
    ...
    def _extract_element_node(self, accessible: Any) -> NormalizedElement:
        ...
        :func:`~pathlight_mcp.backends.normalize.normalize_element`.

        Args:
            accessible: A ``pyatspi.Accessible`` object.

        Returns:
            A :class:`~pathlight_mcp.models.NormalizedElement` with all fields
