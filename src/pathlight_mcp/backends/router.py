...
:class:`~pathlight_mcp.backends.base.DesktopBackend` — tools never know which
...
class BackendRouter(DesktopBackend):
    ...
    Implements the full :class:`~pathlight_mcp.backends.base.DesktopBackend`
    ...
    Args:
        ...
        web: Optional :class:`~pathlight_mcp.backends.web.WebBackend`.
    """
