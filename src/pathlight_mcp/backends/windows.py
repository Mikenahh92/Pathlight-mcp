...
from pathlight_mcp.models.mappings import resolve_role, resolve_state
...
class WindowsBackend(DesktopBackend):
    ...
    def __init__(self) -> None:
        ...
        try:
            ...
            raise BackendUnavailableError(
                ...
                "(install via: pip install 'pathlight_mcp[windows]')"
            ) from None
    ...
    def snapshot(
        ...
        cross-platform mapping tables in :mod:`pathlight_mcp.models.mappings`.
    ...
    def _translate_com_error(
        ...
        Returns:
            The appropriate Pathlight MCP exception.
        """
