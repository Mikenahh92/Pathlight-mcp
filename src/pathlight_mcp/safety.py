"""Element and system-action risk classification for the Pathlight MCP Desktop
...
if TYPE_CHECKING:
    from pathlight_mcp.models import DesktopAction, NormalizedElement
...
def classify(
    ...
    * ``SENSITIVE`` — elements whose activation may cause significant
    ...
    Args:
        ...
        action: The :data:`~pathlight_mcp.models.DesktopAction` being performed.
...
SYSTEM_ACTION_RISK_MAP: dict[SystemAction, RiskLevel] = {
    ...
    "desktop_click_xy": "SENSITIVE",
    "desktop_mouse_move": "INTERACTION",
    "web_connect": "SENSITIVE",
    "web_navigate": "SENSITIVE",
    "web_evaluate": "SENSITIVE",
    "web_inspect": "SENSITIVE",
    "web_click": "INTERACTION",
    "web_type": "INTERACTION",
