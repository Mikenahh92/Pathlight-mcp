...
Registers the ``guidewire://tool-usage`` resource that provides a comprehensive
guide for using all Guidewire desktop tools, organized by category.
"""
...
### Tips
- See the ``guidewire://browser-limitations`` resource for detailed caveats.
...
def register(mcp: "FastMCP") -> None:
    ...
    @mcp.resource(
        ...
        description=(
            "Comprehensive guide for using all Guidewire desktop tools, "
