"""MCP resource handlers for the Guidewire server.
...
Resource set:
    ...
    guidewire://browser-limitations  — browser/web tool limitations and caveats
    guidewire://tool-usage           — tool usage guide with tips per category
    guidewire://error-recovery       — error codes and recovery strategies
"""
