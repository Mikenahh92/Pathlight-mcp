...
Registers the ``guidewire://error-recovery`` resource that documents all
Guidewire error codes, their meanings, and recommended recovery strategies.

The error codes and hints are sourced from :mod:`guidewire.errors` and
:mod:`guidewire.hints` to stay consistent with runtime error responses.
"""
...
def _build_error_recovery_guide() -> str:
    ...
    sections: list[str] = [
        "# Guidewire Error Recovery Guide\n",
        "This document lists all Guidewire error codes, their meanings, and "
...
def register(mcp: "FastMCP") -> None:
    ...
    @mcp.resource(
        ...
        description=(
            "All Guidewire error codes, their meanings, and recommended "
