...
via a :class:`~guidewire.cdp.session.CDPSession`.
"""
...
class CDPDomain:
    ...
    :class:`~guidewire.cdp.session.CDPSession` and exposes high-level,
    typed methods that translate between raw CDP JSON and Guidewire's
    model objects.
    ...
    def _send(
        ...
        *,
        ...
        Raises:
            GuidewireError: For mapped CDP errors.
